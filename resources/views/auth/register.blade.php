        ...
        <div class="row" id="row-mag">
            <div class="col-lg-8 offset-lg-2">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-center" id="login-div" style="background-color: white; border: 0.5px solid lightgray">
                        <form method="POST" action="{{ route('register') }}">
                            <div class="row" style="margin-bottom: 20px;">
                                    ...
                                    <div class="col-12 form-group">
                                        <input type="text" class="form-control radius" name="nick_name" placeholder="Enter Nick Name">
                                    </div>
                                    <div class="col-12 form-group">
                                        <input type="text" class="form-control radius" name="first_name" placeholder="Enter First Name">
                                    </div>
                                    <div class="col-12 form-group">
                                        <input type="text" class="form-control radius" name="last_name" placeholder="Enter Last Name">
                                    </div>
                                    <div class="col-12 form-group">
                                        <input type="email" class="form-control radius" name="email" placeholder="Enter Email">
                                    </div>
                                    <div class="col-12 form-group">
                                        <input type="password" class="form-control radius" name="password" placeholder="Enter Password">
                                    </div>
                                    <div class="col-12 form-group">
                                        <input type="password" class="form-control radius" name="password_confirmation" placeholder="Confirmed Password">
                                    </div>
                                    <div class="col-12 form-group">
                                        <button type="submit" class="btn btn-primary btn-block radius">Sign Up</button>
                                    </div>
                                    <div class="col-12">
                                        or
                                    </div>
