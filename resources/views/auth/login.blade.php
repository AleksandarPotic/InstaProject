                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    <input type="text" class="form-control radius" name="email" placeholder="Enter Email or Nick Name">
                                </div>
                                <div class="col-12 form-group">
                                    <input type="password" class="form-control radius" name="password" placeholder="Enter Password">
                                </div>
                                <div class="col-12 form-group">
                                    <button type="submit" class="btn btn-primary btn-block radius">Log In</button>
                                </div>
                                <div class="col-12">
                                    or
                                </div>
